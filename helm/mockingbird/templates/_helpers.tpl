...
app.kubernetes.io/name: {{ include "mockingbird.name" . }}
...
*/}}
{{- define "mockingbird.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "mockingbird.fullname" .) .Values.serviceAccount.name }}
{{- else }}
